from core.redis import RedisByteManager, RedisStrManager
from core import Singleton

from .dto import IContext
...
class RedisService(Singleton):
    ...
    async def __save(self, context: IContext, b_setter: callable, s_setter: callable):
    ...
    async def __load(self, context: IContext, b_getter: callable, s_getter: callable):
    ...
    async def pop(self, context: IContext):
        await self.__load(
